      ...
      const defaultPicklists = [
        ...
        },
        {
          ...
          items: [
            ...
            { value: 'SVF', label: 'SVF', order: 8 },
            { value: 'AME', label: 'AME', order: 9 },
            { value: 'Caartel Music', label: 'Caartel Music', order: 10 },
            { value: 'Manipuri Zone', label: 'Manipuri Zone', order: 11 },
            { value: 'Getgrist', label: 'Getgrist', order: 12 },
          ]
        },
        {
          name: 'memberStatus',
